...
SimpatoizanteServices gtxsimpatizantes = Get.put(SimpatoizanteServices());
void guardadoExxitosimpatizantes(context) {
  showDialog(
              ...
              children: [
                TextButton(
                    onPressed: () async {
                      ...
                      var r = await gtxsimpatizantes.getNumberEncuestas();
                       await gtxsimpatizantes.reset();
                      ...
                      Navigator.pushAndRemoveUntil(
                        context,
                        MaterialPageRoute(
                          builder: (BuildContext context) => menuSimpatizantesPage(),
                        ),
                        (route) => false,
                      );
                    },
