...
import 'package:app_encuestas/murales/pages/nuevo_mural_page.dart';
...
import '../../menu/services/serviceMenu.dart';

class MuralesPage extends StatefulWidget {
  const MuralesPage({Key? key}) : super(key: key);

  @override
  State<MuralesPage> createState() => _MuralesPageState();
}

class _MuralesPageState extends State<MuralesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Obx(() => gtxmenu.esperar.value == false
            ? Stack(children: [
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                          ...
                          child: Obx(
                            () => Text(
                              gtxmurales.numeroEncuestas.value.toString(),
                              style:
                      ...
                      InkWell(
                        ...
                        gtxmenu.esperar.value =true;
                              var r =
                                  await gtxmurales.getLocalStorage();
                                  if(r["status"]=="ok"){
                                    sincronizadoCorrecto(context);
                                    gtxmurales.getNumberEncuestas();
